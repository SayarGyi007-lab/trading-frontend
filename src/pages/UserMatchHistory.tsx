...
import { useGetUserMatchingsQuery } from "../slices/matchApi";
import bgImage from "../assets/ec1.jpg"; 

const UserMatchings: React.FC = () => {
  const { data, error, isLoading } = useGetUserMatchingsQuery();
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-white text-center">Matchings</h1>
